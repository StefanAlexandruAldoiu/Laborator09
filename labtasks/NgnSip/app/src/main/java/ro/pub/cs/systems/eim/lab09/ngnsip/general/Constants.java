...
public interface Constants {
    ...
    final public static String USERNAME = "alex.aldoiust";
    final public static String IDENTITY_IMPI = "upb10";
    final public static String IDENTITY_PASSWORD = "vxAZraEiy3JamQ2g";
    final public static String DOMAIN = "upb10.onsip.com";
    final public static String NETWORK_PCSCF_HOST = "sip.onsip.com";
    final public static int NETWORK_PCSCF_PORT = 5060;
    final public static String NETWORK_REALM = "upb10.onsip.com";
